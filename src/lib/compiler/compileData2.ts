...
export interface PrecompiledTileset {
  symbolName: string;
  data: Uint8Array;
}
...
export const compileScene = (
  ...
  console.log({ scene, ps: scene.playerSprite });
...
export const compileTileset = (tileset: PrecompiledTileset) =>
  toStructDataFile(
    TILESET_TYPE,
    tileset.symbolName,
...
export const compileTilesetHeader = (tileset: PrecompiledTileset) =>
  toDataHeader(
    TILESET_TYPE,
    tileset.symbolName,
    `// Tileset: ${tileset.symbolName}`
